...
in {
  flake.modules.homeManager.desktop = let
    hyprmoncfg = config.flake.modules.homeManager.hyprmoncfg;
  in
    {
      pkgs,
      lib,
    ...
    in {
      ...
      config = {
        ...
        wayland.windowManager.hyprland = {
          ...
          # Monitor layout is owned by the hyprmoncfg aspect
          # (modules/home/hyprmoncfg/default.nix), which declares the guarded dofile
          # include for hyprmoncfg-monitors.lua.
          settings = {
